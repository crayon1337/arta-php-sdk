...
| ------------- | ------------- | ------------- |
| [**invoicesGet()**](InvoicesApi.md#invoicesGet) | **GET** /invoices/{invoice_id} | Get an Invoice record |
| [**invoicesList()**](InvoicesApi.md#invoicesList) | **GET** /invoices | List invoice records |
