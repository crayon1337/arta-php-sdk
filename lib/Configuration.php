...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.arta.io';
    ...
    {
        $report  = 'PHP SDK (Arta\Client) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2021-01-01' . PHP_EOL;
