...
/**
 * ShipmentPackagesInnerObjectsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ShipmentPackagesInnerObjectsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shipment_packages_inner_objects_inner';
    ...
    protected static $openAPITypes = [
        ...
        'depth' => 'string',
        'details' => '\OpenAPI\Client\Model\ShipmentPackagesInnerObjectsInnerDetails',
        'height' => 'string',
        'id' => 'int',
        'images' => 'string[]',
    ...
    */
     ...
     * Gets details
     *
     * @return \OpenAPI\Client\Model\ShipmentPackagesInnerObjectsInnerDetails|null
     */
     ...
     * Sets details
     *
     * @param \OpenAPI\Client\Model\ShipmentPackagesInnerObjectsInnerDetails|null $details details
     *
     * @return self
     */
    ...
    public function setInternalReference($internal_reference)
    {
        ...
        if (!is_null($internal_reference) && (mb_strlen($internal_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $internal_reference when calling ShipmentPackagesInnerObjectsInner., must be smaller than or equal to 255.');
        }
    ...
    public function setPublicReference($public_reference)
    {
        ...
        if (!is_null($public_reference) && (mb_strlen($public_reference) > 255)) {
            throw new \InvalidArgumentException('invalid length for $public_reference when calling ShipmentPackagesInnerObjectsInner., must be smaller than or equal to 255.');
        }
     ...
     * Sets subtype
     *
     * @param string|null $subtype The object sub-type id
     *
     * @return self
     */
    public function setSubtype($subtype)
    {
        ...
        if ((!preg_match("/^[0-9a-z_]{1,56}$/", ObjectSerializer::toString($subtype)))) {
            throw new \InvalidArgumentException("invalid value for \$subtype when calling ShipmentPackagesInnerObjectsInner., must conform to the pattern /^[0-9a-z_]{1,56}$/.");
        }
    ...
    public function setType($type)
    {
        ...
        if ((!preg_match("/^[0-9a-z_]{1,56}$/", ObjectSerializer::toString($type)))) {
            throw new \InvalidArgumentException("invalid value for \$type when calling ShipmentPackagesInnerObjectsInner., must conform to the pattern /^[0-9a-z_]{1,56}$/.");
        }
    ...
    public function setValue($value)
    {
        ...
        if ((!preg_match("/^(0|([1-9]+[0-9]*))(\\.[0-9]{1,2})?$/", ObjectSerializer::toString($value)))) {
            throw new \InvalidArgumentException("invalid value for \$value when calling ShipmentPackagesInnerObjectsInner., must conform to the pattern /^(0|([1-9]+[0-9]*))(\\.[0-9]{1,2})?$/.");
        }
    ...
    public function setValueCurrency($value_currency)
    {
        ...
        if ((mb_strlen($value_currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $value_currency when calling ShipmentPackagesInnerObjectsInner., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($value_currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $value_currency when calling ShipmentPackagesInnerObjectsInner., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($value_currency)))) {
            throw new \InvalidArgumentException("invalid value for \$value_currency when calling ShipmentPackagesInnerObjectsInner., must conform to the pattern /^[A-Z]{3}$/.");
        }
