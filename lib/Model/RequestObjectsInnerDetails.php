...
/**
 * RequestObjectsInnerDetails Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RequestObjectsInnerDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'request_objects_inner_details';
    ...
    */
     ...
     * Sets materials
     *
     * @param string[]|null $materials A list of IDs describing the types of materials used. Options are defined in the Object Materials metadata endpoint
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets notes
     *
     * @param string|null $notes Any notes about the object
     *
     * @return self
     */
