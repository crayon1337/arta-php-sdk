...
/**
 * MetadataApiVersions200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  Arta\Client
 * @author   OpenAPI Generator team
 ...
 */
class MetadataApiVersions200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'metadata_apiVersions_200_response_inner';
    ...
    */
     ...
     * Sets authentication
     *
     * @param string[]|null $authentication The list of authentication schema supported by this API version
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Indicates whether the API version is active, beta, or deprecated
     *
     * @return self
     */
