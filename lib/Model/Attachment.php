...
class Attachment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets request_id
     *
     * @param string|null $request_id The string ID of the request resource associated to an upload via this attachment. Null if this attachment associate a shipment
     *
     * @return self
     */
     ...
     * Sets shipment_id
     *
     * @param string|null $shipment_id The string ID of the shipment resource associated to an upload via this attachment. Null if this attachment associate a request
     *
     * @return self
     */
     ...
     * Sets upload_id
     *
     * @param int $upload_id The integer ID of the Upload resource associated with either a shipment or request via this attachment
     *
     * @return self
     */
