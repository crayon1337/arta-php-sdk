...
/**
 * RequestDisqualificationsInner Class Doc Comment
 *
 * @category Class
 ...
 */
class RequestDisqualificationsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'request_disqualifications_inner';
    ...
    */
     ...
     * Sets quote_types
     *
     * @param string[]|null $quote_types The list of quote types disqualified with this reason
     *
     * @return self
     */
     ...
     * Sets reason
     *
     * @param string|null $reason A brief explanation of the disqualification
     *
     * @return self
     */
     ...
     * Sets reason_code
     *
     * @param string|null $reason_code An ID for the disqualification
     *
     * @return self
     */
