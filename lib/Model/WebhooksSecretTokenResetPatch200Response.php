...
/**
 * WebhooksSecretTokenResetPatch200Response Class Doc Comment
 *
 * @category Class
 * @package  Arta\Client
 * @author   OpenAPI Generator team
 ...
 */
class WebhooksSecretTokenResetPatch200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webhooks_secret_token_reset_patch_200_response';
    ...
    */
     ...
     * Sets secret_token
     *
     * @param string|null $secret_token The new secret token associated with the webhook endpoint
     *
     * @return self
     */
