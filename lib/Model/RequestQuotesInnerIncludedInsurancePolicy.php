...
/**
 * RequestQuotesInnerIncludedInsurancePolicy Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RequestQuotesInnerIncludedInsurancePolicy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'request_quotes_inner_included_insurance_policy';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['insured_value']) && !preg_match("/^(0|([1-9]+[0-9]*))(\\.[0-9]{1,2})?$/", $this->container['insured_value'])) {
            $invalidProperties[] = "invalid value for 'insured_value', must be conform to the pattern /^(0|([1-9]+[0-9]*))(\\.[0-9]{1,2})?$/.";
        }
    ...
    public function setAmount($amount)
    {
        ...
        if ((!preg_match("/^(0|([1-9]+[0-9]*))(\\.[0-9]{1,2})?$/", ObjectSerializer::toString($amount)))) {
            throw new \InvalidArgumentException("invalid value for \$amount when calling RequestQuotesInnerIncludedInsurancePolicy., must conform to the pattern /^(0|([1-9]+[0-9]*))(\\.[0-9]{1,2})?$/.");
        }
    ...
    public function setAmountCurrency($amount_currency)
    {
        ...
        if ((mb_strlen($amount_currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $amount_currency when calling RequestQuotesInnerIncludedInsurancePolicy., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($amount_currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $amount_currency when calling RequestQuotesInnerIncludedInsurancePolicy., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($amount_currency)))) {
            throw new \InvalidArgumentException("invalid value for \$amount_currency when calling RequestQuotesInnerIncludedInsurancePolicy., must conform to the pattern /^[A-Z]{3}$/.");
        }
    ...
    public function setInsuredValue($insured_value)
    {
        ...
        if ((!preg_match("/^(0|([1-9]+[0-9]*))(\\.[0-9]{1,2})?$/", ObjectSerializer::toString($insured_value)))) {
            throw new \InvalidArgumentException("invalid value for \$insured_value when calling RequestQuotesInnerIncludedInsurancePolicy., must conform to the pattern /^(0|([1-9]+[0-9]*))(\\.[0-9]{1,2})?$/.");
        }
     ...
     *
     * @param string|null $insured_value_currency ISO 4217 three-letter alphabetic currency code. Options are defined in the Currencies metadata endpoint
     *
     * @return self
     */
    public function setInsuredValueCurrency($insured_value_currency)
    {
        ...
        if ((mb_strlen($insured_value_currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $insured_value_currency when calling RequestQuotesInnerIncludedInsurancePolicy., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($insured_value_currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $insured_value_currency when calling RequestQuotesInnerIncludedInsurancePolicy., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($insured_value_currency)))) {
            throw new \InvalidArgumentException("invalid value for \$insured_value_currency when calling RequestQuotesInnerIncludedInsurancePolicy., must conform to the pattern /^[A-Z]{3}$/.");
        }
