 ...
 */
class RequestsUpdateContactsRequestOrigin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'requests_update_contacts_request_origin';
