 ...
 */
class MetadataServices200ResponseInnerSubtypesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'metadata_services_200_response_inner_subtypes_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('sub_subtypes', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['sub_subtypes'];
    }
     ...
     * @return self
     */
    public function setSubSubtypes($sub_subtypes)
    {
        if (is_null($sub_subtypes)) {
            throw new \InvalidArgumentException('non-nullable sub_subtypes cannot be null');
        }
        $this->container['sub_subtypes'] = $sub_subtypes;
