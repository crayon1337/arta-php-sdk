...
/**
 * EmailRulesCreateRequestEmailRule Class Doc Comment
 *
 * @category Class
 * @package  Arta\Client
 * @author   OpenAPI Generator team
 ...
 */
class EmailRulesCreateRequestEmailRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'emailRules_create_request_email_rule';
    ...
    {
        $this->setIfExists('email_notification_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['email_notification_id'] === null) {
            $invalidProperties[] = "'email_notification_id' can't be null";
        }
     ...
     *
     * @param string $email_notification_id The ID belonging to the Email Notification for this Email Rule.
     *
     * @return self
     */
    public function setEmailNotificationId($email_notification_id)
    {
        if (is_null($email_notification_id)) {
            throw new \InvalidArgumentException('non-nullable email_notification_id cannot be null');
        }
     ...
     * Sets recipients
     *
     * @param string[] $recipients The list of recipients for this Email Rule.
     *
     * @return self
     */
