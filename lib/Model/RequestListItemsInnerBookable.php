...
/**
 * RequestListItemsInnerBookable Class Doc Comment
 *
 * @category Class
 ...
 */
class RequestListItemsInnerBookable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'requestList_items_inner_bookable';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('ready', $data ?? [], true);
    }
    ...
    */
     ...
     * Sets missing
     *
     * @param string[]|null $missing A list of fields required for the request to be bookable
     *
     * @return self
     */
     ...
     * Sets ready
     *
     * @param bool|null $ready Returns true if the quotes in this request may be booked
     *
     * @return self
     */
