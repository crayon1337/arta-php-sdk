...
/**
 * ShipmentExceptionsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ShipmentExceptionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shipment_exceptions_inner';
    ...
    */
     ...
     * Sets created_at
     *
     * @param string|null $created_at A NaiveDatetime-formatted timestamp describing when the exception was created with microsecond precision
     *
     * @return self
     */
     ...
     *
     * @param string|null $exception_type_label An additional label providing context about the exception type (optional)
     *
     * @return self
     */
     ...
     * Sets package_id
     *
     * @param int|null $package_id The package associated with this exception (optional)
     *
     * @return self
     */
     ...
     * Sets resolution
     *
     * @param string|null $resolution A brief description of the method by which this exception was resolved
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status The current status for this exception
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The type of exception
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param string|null $updated_at A NaiveDatetime-formatted timestamp describing when the exception was last updated with microsecond precision
     *
     * @return self
     */
