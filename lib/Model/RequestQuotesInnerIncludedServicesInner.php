...
/**
 * RequestQuotesInnerIncludedServicesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RequestQuotesInnerIncludedServicesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'request_quotes_inner_included_services_inner';
    ...
    */
    ...
    public function setAmount($amount)
    {
        ...
        if ((!preg_match("/^(0|([1-9]+[0-9]*))(\\.[0-9]{1,2})?$/", ObjectSerializer::toString($amount)))) {
            throw new \InvalidArgumentException("invalid value for \$amount when calling RequestQuotesInnerIncludedServicesInner., must conform to the pattern /^(0|([1-9]+[0-9]*))(\\.[0-9]{1,2})?$/.");
        }
    ...
    public function setAmountCurrency($amount_currency)
    {
        ...
        if ((mb_strlen($amount_currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $amount_currency when calling RequestQuotesInnerIncludedServicesInner., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($amount_currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $amount_currency when calling RequestQuotesInnerIncludedServicesInner., must be bigger than or equal to 3.');
        }
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($amount_currency)))) {
            throw new \InvalidArgumentException("invalid value for \$amount_currency when calling RequestQuotesInnerIncludedServicesInner., must conform to the pattern /^[A-Z]{3}$/.");
        }
     ...
     * Sets is_requested
     *
     * @param bool|null $is_requested is_requested
     *
     * @return self
     */
