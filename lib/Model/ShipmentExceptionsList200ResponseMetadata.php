...
/**
 * ShipmentExceptionsList200ResponseMetadata Class Doc Comment
 *
 * @category Class
 * @package  Arta\Client
 * @author   OpenAPI Generator team
 ...
 */
class ShipmentExceptionsList200ResponseMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shipmentExceptions_list_200_response_metadata';
    ...
    {
        $this->setIfExists('is_estimate', $data ?? [], null);
    ...
    */
     ...
     * Sets is_estimate
     *
     * @param bool|null $is_estimate is_estimate
     *
     * @return self
     */
    public function setIsEstimate($is_estimate)
    {
        if (is_null($is_estimate)) {
            throw new \InvalidArgumentException('non-nullable is_estimate cannot be null');
        }
