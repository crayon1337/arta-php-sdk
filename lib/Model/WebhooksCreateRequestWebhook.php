...
/**
 * WebhooksCreateRequestWebhook Class Doc Comment
 *
 * @category Class
 * @package  Arta\Client
 * @author   OpenAPI Generator team
 ...
 */
class WebhooksCreateRequestWebhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'webhooks_create_request_webhook';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name for this Webhook.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url The URL for this Webhook.
     *
     * @return self
     */
