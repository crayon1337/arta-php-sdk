...
/**
 * UploadWithPresignedUrl Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UploadWithPresignedUrl implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'uploadWithPresignedUrl';
    ...
    */
     ...
     * Sets presigned_url
     *
     * @param string|null $presigned_url A pre-signed and secure URL to use to send the file to Arta via a PUT HTTP request within 20 seconds of the upload resource being created
     *
     * @return self
     */
    public function setPresignedUrl($presigned_url)
    {
        if (is_null($presigned_url)) {
            throw new \InvalidArgumentException('non-nullable presigned_url cannot be null');
        }
