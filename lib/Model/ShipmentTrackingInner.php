...
/**
 * ShipmentTrackingInner Class Doc Comment
 *
 * @category Class
 ...
 */
class ShipmentTrackingInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shipment_tracking_inner';
    ...
    */
     ...
     * Sets carrier_name
     *
     * @param string|null $carrier_name The name of the carrier providing transport services for a specific package
     *
     * @return self
     */
     ...
     * Sets label_url
     *
     * @param string|null $label_url A URL at which parcel package shipping labels may be downladed and printed
     *
     * @return self
     */
     ...
     * Sets package_id
     *
     * @param int|null $package_id The ID associated with the tracking detail's corresponding package
     *
     * @return self
     */
     ...
     *
     * @param string|null $tracking_number The carrier-providing tracking number for this package
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url A carrier-provided URL for fetching delivery events related to this package's transport
     *
     * @return self
     */
