...
/**
 * AttachmentsCreateRequestAttachment Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AttachmentsCreateRequestAttachment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'attachments_create_request_attachment';
    ...
    */
     ...
     * Sets upload_id
     *
     * @param int $upload_id The integer ID of the upload resource being attached
     *
     * @return self
     */
     ...
     * Sets request_id
     *
     * @param string|null $request_id The string ID of the request resource being associated to an upload. Do not include a request_id in the attachment parameters if you are associating a shipment
     *
     * @return self
     */
     ...
     * Sets shipment_id
     *
     * @param string|null $shipment_id The string ID of the shipment resource being associated to an upload. Do not include a shipment_id in the attachment parameters if you are associating a shipment
     *
     * @return self
     */
