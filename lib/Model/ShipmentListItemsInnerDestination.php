...
/**
 * ShipmentListItemsInnerDestination Class Doc Comment
 *
 * @category Class
 ...
 */
class ShipmentListItemsInnerDestination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shipmentList_items_inner_destination';
    ...
    */
     ...
     * Sets city
     *
     * @param string|null $city The destination address city
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param string|null $country The destination address country in 2-digit ISO 3166-1 alpha-2 format
     *
     * @return self
     */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code The destination address postal code
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string|null $region The destination address region
     *
     * @return self
     */
