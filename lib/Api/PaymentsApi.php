...
/**
    ...
    {
        list($response) = $this->paymentsGetWithHttpInfo($authorization, $payment_id, $contentType);
        return $response;
    }
     ...
     */
    public function paymentsGetAsync($authorization, $payment_id, string $contentType = self::contentTypes['paymentsGet'][0])
    {
        return $this->paymentsGetAsyncWithHttpInfo($authorization, $payment_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function paymentsGetRequest($authorization, $payment_id, string $contentType = self::contentTypes['paymentsGet'][0])
    {
        ...
        if ($payment_id === null || (is_array($payment_id) && count($payment_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payment_id when calling paymentsGet'
            );
        }
    ...
    {
        list($response) = $this->paymentsListWithHttpInfo($authorization, $page_size, $page, $contentType);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function paymentsListAsync($authorization, $page_size = 20, $page = 1, string $contentType = self::contentTypes['paymentsList'][0])
    {
        return $this->paymentsListAsyncWithHttpInfo($authorization, $page_size, $page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function paymentsListRequest($authorization, $page_size = 20, $page = 1, string $contentType = self::contentTypes['paymentsList'][0])
    {

        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling paymentsList'
            );
        }
